              ...
              return (
                <div key={index} className="flex flex-col items-center text-center group">
                  <div className="relative mb-8">
                    ...
                    <div className="relative flex h-20 w-20 items-center justify-center rounded-full<dyad-write path="src/pages/LandingPage.tsx" description="Yepyeni, modern ve interaktif bir anasayfa tasarımı.">
import { Link } from 'react-router-dom';
import { Button } from '@/components/ui/button';
